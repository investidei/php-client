...
abstract class DataStructure implements  JsonSerializable, ArrayAccess{
	...
	abstract function seed(array $data) ;
	 ...
	 * @return array
	 */
	public function toArray($transformType = null) {
		// todo: use only public properties
		$array = get_object_vars($this);
		$hidden = array_merge($this->hidden, ['hidden']);
		$transformedArray = array_except($array, $hidden);

		return $this->transformKeys($transformedArray, $transformType);
	}
